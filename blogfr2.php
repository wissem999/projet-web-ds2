...
<body>
    <header>
        <h1 style="color: red;">Solidarité internationale : Des actions de soutien en faveur de la Palestine</h1>
    </header>
    <main>
        <article>
            <img src="pales2.avif" alt="Image de l'article">
            <h2 style="color: red;">Un symbole de solidarité à travers les drapeaux palestiniens</h2>
            <p>During this demonstration, participants took the opportunity to denounce the injustices and human rights violations perpetrated in Palestine. Speeches reiterated the urgency of an immediate ceasefire, as well as the need for international intervention to end the suffering of Palestinian civilians. Beyond the symbolism of the flags, these actions are a call for peace and justice in the region.</p>
